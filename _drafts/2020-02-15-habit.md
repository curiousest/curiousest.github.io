...
Goal -> habit to achieve goal. Habit is a tool to achieve goals, and as you become attached to them, they can become goals themselves.

A habit is:
1. A trigger, or cue. (anchor)
2. A routine. (behavior - motivation + ability + prompt)
3. A reward (celebration)
(tiny habits)
