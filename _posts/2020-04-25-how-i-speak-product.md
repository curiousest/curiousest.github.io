...
Sometimes you define the problem, list solutions, and pick the best ones. Systematic and explainable.
...
## Salesperson asks for a small feature
...
Every second spent clarifying the problem is not spent making the solution happen. Like all things in product, you must aim to do exactly what is needed and no more.
